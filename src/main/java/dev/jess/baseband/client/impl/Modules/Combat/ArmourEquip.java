...
public class ArmourEquip extends Module {

	public final Setting delay = new Setting("Delay", this, 80, 10, 500, true);
	TimerUtil timer = new TimerUtil();

	public ArmourEquip() {
		super("ArmourEquip", "ReEquip Armour", Category.COMBAT, new Color(171, 103, 218, 255).getRGB());
		BaseBand.settingsManager.rSetting(delay);
	}

	public void tick() {
		if (timer.passedMs((int) delay.getValDouble())) {
			timer.reset();
