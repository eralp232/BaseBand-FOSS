package dev.jess.baseband.client.impl.CatGUI.component;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for (Module mod : ModuleRegistry.getModulesInCategory(cat)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		Gui.drawRect(this.x, this.y, this.x + this.width, this.y + this.barHeight, CatGUI.color);
		GL11.glPushMatrix();
