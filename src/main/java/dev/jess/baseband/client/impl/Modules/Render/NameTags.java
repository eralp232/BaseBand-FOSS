...
public class NameTags extends Module {
	CFontRenderer cFontRenderer = new CFontRenderer(new Font("Arial", Font.PLAIN, 18), true, false);


	public NameTags() {
		super("NameTags", "Yawn.", Category.RENDER, new Color(231, 151, 252, 255).getRGB());
	}
