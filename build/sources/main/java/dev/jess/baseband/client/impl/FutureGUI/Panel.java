...
public abstract class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		RenderMethods.drawGradientRect(this.x, (float) this.y - 1.5f, this.x + this.width, this.y + this.height - 6, ColorModule.getColor(242).getRGB(), ColorModule.getColor(242).getRGB());
	...
	public void keyTyped(char keyTyped, int keyCode) {
		//if (open) {
		for (Item item : getItems()) {
			item.keyTyped(keyTyped, keyCode);
		}
		//}
	}
